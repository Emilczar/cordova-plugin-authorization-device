...
var PLUGIN_NAME = "AuthorizationDevice";

var AuthorizationDevice = function() {};

AuthorizationDevice.startPlugin = function(options, onSuccess, onError) {
	options = options || {};
...
module.exports = AuthorizationDevice;
